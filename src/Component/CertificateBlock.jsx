...
function CertificateBlock(props) {
  ...
  return (
    <div className={`relative w-full max-w-[90vw] md:max-w-[400px] aspect-[7/4] rounded-2xl border border-gray-300 dark:border-gray-700 overflow-hidden group transition-all duration-500 shadow-lg hover:shadow-2xl mx-auto ${className}`} onClick={() => { if (eventListeners) window.open(certificate.link, "_blank") }}>
