...
function AchievementBlock(props) {
  ...
  return (
    <div className="flex flex-col justify-start bg-[#e1e1e1] dark:bg-[#1e1e1e] border border-yellow-400 rounded-xl p-4 shadow-md w-[400px] h-[200px] transition duration-300 hover:shadow-yellow-400/50 hover:shadow-lg hover:border-yellow-300">
