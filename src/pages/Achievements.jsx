    ...
    return (
        <div className='flex flex-col w-full gap-y-10 bg-gray-100 dark:bg-gray-900 py-20 px-6 box-border z-5' id="achievements" ref={el => (navigationRefs.current["achievements"] = el)}>
            <div className='flex gap-x-3 w-full justify-center items-center'>
                <GrAchievement className='text-black dark:text-white text-[clamp(1.5rem,4vw,3rem)] font-bold' />
                <span className='text-black dark:text-white text-[clamp(1.5rem,4vw,3rem)] font-bold text-center'>Achievements <span className='text-yellow-300'>Unlocked</span></span>
            </div>
