...
function Intro() {
    ...
    return (
        <div className='flex flex-col md:flex-row min-h-screen w-full bg-white text-gray-900 dark:bg-black dark:text-gray-100 py-24 px-6 md:px-12 items-center justify-center gap-10' id={"home"} ref={el => (navigationRefs.current["home"] = el)}>
            <div className="flex flex-col justify-center items-center md:items-start gap-y-4 w-full md:w-2/3 text-center md:text-left order-2 md:order-1 md:pl-4 pl-6 md:pr-8 pr-12">
                <p className='text-black dark:text-white text-[clamp(1.5rem,4vw,3rem)] tracking-widest font-bold leading-tight'>Hi There</p>
                <p className='text-black dark:text-white text-[clamp(1.5rem,4vw,3rem)] tracking-widest font-bold leading-tight'>I'm <span className='text-orange-400'>Ashok Bhatt</span></p>
                ...
                <div className='text-md md:text-lg text-gray-700 dark:text-gray-300 mt-4 leading-relaxed'>
                    I am a <span className='text-green-600 dark:text-green-400 font-semibold'>final-year B.Tech Computer Science student</span> at ITM(SLS) Baroda University and an aspiring software developer. I specialize in building modern web applications using <span className='text-green-600 dark:text-green-400 font-semibold'>React</span> and <span className='text-green-600 dark:text-green-400 font-semibold'>Express</span>. Beyond that, I have hands-on experience in <span className='text-green-600 dark:text-green-400 font-semibold'>mobile and desktop development</span>, backed by a strong foundation in <span className='text-green-600 dark:text-green-400 font-semibold'>Python</span>, <span className='text-green-600 dark:text-green-400 font-semibold'>C++</span>, <span className='text-green-600 dark:text-green-400 font-semibold'>DSA</span>, <span className='text-green-600 dark:text-green-400 font-semibold'>Generative AI</span>, and <span className='text-green-600 dark:text-green-400 font-semibold'>Databases</span>.
                </div>
