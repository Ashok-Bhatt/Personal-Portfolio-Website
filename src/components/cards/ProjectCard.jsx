      ...
      <div className={`absolute bottom-0 w-full translate-y-full ${isActive ? 'group-hover:translate-y-0' : ''} transition-transform duration-500`}>
        ...
        <div className='p-4 md:p-6 bg-white/95 text-black'>
          ...
          <div className='flex justify-between items-center gap-x-4'>
            ...
            <div className="flex flex-1 items-center justify-center gap-x-2 bg-gray-200 text-black py-2 px-4 hover:cursor-pointer rounded-lg font-semibold transition-colors" onClick={(e) => { e.stopPropagation(); window.open(project.repoLink, "_blank") }}>
              <FaCode />
              <span>Code</span>
            </div>
          </div>
